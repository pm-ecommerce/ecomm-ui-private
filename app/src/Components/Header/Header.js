...
const Header = (props) => {
  ...
  const fetchSessionId = () => {
    if (localStorage.getItem("cart") === null) {
      // fetch(`${ config.baseUrl }/pm-ecomm-shopping-cart/api/cart`)
      fetch("http://localhost:8084/api/cart", {
        method: "POST",
      })
        .then((res) => res.json())
        .then((res) => {
...
>>>>>>> 95cded9cdf4cae176cde2888ff8a141de5443f70
                  ...
                  >
                    <div className="shopcart">
                      ...
                      <div className="shopcart-inner">
                        ...
                        <span className="total-shopping-cart cart-total-full">
                          <span className="items_cart">02</span>
                          <span className="items_cart2"> item(s)</span>
                          <span className="items_carts"> - $162.00 </span>
                        </span>
                      </div>
                    </div>
                  </a>
